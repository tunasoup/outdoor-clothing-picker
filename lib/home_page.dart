...
class _HomePageState extends State<HomePage> {
  int currentPageIndex = 0;  // Initial value is the landing page (in pages variable)
  ...
  //   (bottomNav) => SettingsPage(bottomNavigationBar: bottomNav, viewModel: SettingsViewModel()),
  // ];
